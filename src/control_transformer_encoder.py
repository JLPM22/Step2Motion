...
from control_transformer_encoder_layer import ControlTransformerEncoderLayer


# This is a copy from PyTorch's TransformerEncoder slightly modified
class ControlTransformerEncoder(nn.Module):

    __constants__ = ["norm"]

    def __init__(
        self,
        encoder_layer: ControlTransformerEncoderLayer,
        num_layers: int,
